...
if (isset($_POST['submit'])) {
	...
	if($_POST['type_short'] == 'tinyurl'){
		update_option('tweetmp_shorturl', 'http://tinyurl.com/api-create.php?url=%link%');
	}
	if($_POST['type_short'] == 'md2.in'){
		update_option('tweetmp_shorturl', 'http://md2.in/api.php?url=%link%');
	}
	if($_POST['type_short'] == 'goo.gl'){
		update_option('tweetmp_shorturl', 'http://md2.in/googl.php?url=%link%');
	}
	...
	if($_POST['type_short'] == 'saf.li'){
		update_option('tweetmp_shorturl', 'http://saf.li/create?ws=1&url=%link%');
	}
...
<table class="form-table">
	<tr>
		<td width="35%"><label><input name="type_short" type="radio" value="tinyurl" <?php if(get_option('tweetmp_typeshort') == 'tinyurl'){echo'checked';}?>/> tinyurl</label></td>
		<td width="65%"><label><input name="type_short" type="radio" value="goo.gl" <?php if(get_option('tweetmp_typeshort') == 'goo.gl'){echo'checked';}?>/> goo.gl</label></td>
	</tr>
	<tr>
		<td width="35%"><label><input name="type_short" type="radio" value="saf.li" <?php if(get_option('tweetmp_typeshort') == 'saf.li'){echo'checked';}?>/> saf.li</label></td>
		<td width="65%"><label><input name="type_short" type="radio" value="md2.in" <?php if(get_option('tweetmp_typeshort') == 'md2.in'){echo'checked';}?>/> md2.in</label></td>
	</tr>
	<tr>
